...
def draw_shape(side_length = int(input("What side length would you like? ")), num_sides = int(input("How many sides would you like? ")), num_shapes = int(input("How many shapes would you like? "))): 
